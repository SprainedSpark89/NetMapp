...
public class r12w24a extends ReleaseSnapshotVersion { // changes to item nbt read/write, unknown if there's a required change

	public r12w24a(Versions ver) {
		super(ver);
		this.version = "12w24a";
		this.protocolNumber = 36;
