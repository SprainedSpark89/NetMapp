package io.github.SprainedSpark89.netmapp.version.java.release.snapshot.r12w22a;
...
public class PacketPlace extends Packet {
	...
	public void read(ByteBuffer buf, ParsedPacket out, StringBuilder desc, Class<?> arg) {
		...
		byte fX = (byte)NetMapp.parseArgs(out.packet, buf, Byte.TYPE, (short) 0), fY = (byte)NetMapp.parseArgs(out.packet, buf, Byte.TYPE, (short) 0), fZ = (byte)NetMapp.parseArgs(out.packet, buf, Byte.TYPE, (short) 0);
		...
		out.values.add(fX);
		desc.append("Byte: ").append(fX).append(", ");
		out.values.add(fY);
		desc.append("Byte: ").append(fY).append(", ");
		out.values.add(fZ);
		desc.append("Byte: ").append(fZ).append(", ");
	}
