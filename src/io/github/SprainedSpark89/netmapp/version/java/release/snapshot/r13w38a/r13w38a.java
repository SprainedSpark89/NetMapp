package io.github.SprainedSpark89.netmapp.version.java.release.snapshot.r13w38a;
...
import io.github.SprainedSpark89.netmapp.version.java.release.r161.PacketServerListEntry;
import io.github.SprainedSpark89.netmapp.version.java.release.r162.PacketEntityData;
...
import io.github.SprainedSpark89.netmapp.version.java.release.snapshot.r13w04a.PacketScoreboardDisplay;
import io.github.SprainedSpark89.netmapp.version.java.release.snapshot.r13w04a.PacketScoreboardObjective;
import io.github.SprainedSpark89.netmapp.version.java.release.snapshot.r13w04a.PacketScoreboardScore;
import io.github.SprainedSpark89.netmapp.version.java.release.snapshot.r13w09a.PacketTeaming;
import io.github.SprainedSpark89.netmapp.version.java.release.snapshot.r13w09c.PacketParticles;
import io.github.SprainedSpark89.netmapp.version.java.release.snapshot.r13w16a.PacketEntityMount;
import io.github.SprainedSpark89.netmapp.version.java.release.snapshot.r13w16a.PacketHealth;
import io.github.SprainedSpark89.netmapp.version.java.release.snapshot.r13w16a.PacketPerms;
import io.github.SprainedSpark89.netmapp.version.java.release.snapshot.r13w16a.PacketPlayerActionChange;
import io.github.SprainedSpark89.netmapp.version.java.release.snapshot.r13w16b.PacketPlayerInput;
import io.github.SprainedSpark89.netmapp.version.java.release.snapshot.r13w21a.PacketOpenInv;
import io.github.SprainedSpark89.netmapp.version.java.release.snapshot.r13w36a.PacketSound;
import io.github.SprainedSpark89.netmapp.version.java.release.snapshot.r13w36a.PacketStat;

public class r13w38a extends ReleaseSnapshotVersion {

	public r13w38a(Versions ver) {
		super(ver);
		this.version = "13w38a";
		this.protocolNumber = 79;
		...
		p = new PacketEntityData(new ArrayList<Class<?>>(), new ArrayList<String>()); // 44
		this.packetList.put(p, p.packetType);
		...
		p = new PacketParticles(new ArrayList<Class<?>>(), new ArrayList<String>()); // 62
		this.packetList.put(p, p.packetType);
		...
		p = new PacketTeaming(new ArrayList<Class<?>>(), new ArrayList<String>()); // 209
		this.packetList.put(p, p.packetType);
