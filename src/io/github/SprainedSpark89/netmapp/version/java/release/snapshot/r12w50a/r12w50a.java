package io.github.SprainedSpark89.netmapp.version.java.release.snapshot.r12w50a;
...
public class r12w50a extends ReleaseSnapshotVersion { // and there goes another packet

	public r12w50a(Versions ver) {
		super(ver);
		this.version = "12w50a";
		this.protocolNumber = 51;
