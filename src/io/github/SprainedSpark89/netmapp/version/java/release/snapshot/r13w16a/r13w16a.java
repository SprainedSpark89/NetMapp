...
public class r13w16a extends ReleaseSnapshotVersion { // PacketPlayerInput re-added, not registered, but attempts to sent anyway, client NPEs

	public r13w16a(Versions ver) {
		super(ver);
		this.version = "13w16a";
		this.protocolNumber = 62;
