...
import io.github.SprainedSpark89.netmapp.version.java.classic.c20.PacketLogin;

public class c0_30 extends ClassicVersion {

	public c0_30(Versions ver) {
		super(ver);
		// TODO Auto-generated constructor stub
		this.version = "c0.30";
		this.protocolNumber = (byte)7;
		...
		p = new PacketPermissions(new ArrayList<Class<?>>(), new ArrayList<String>());
		this.packetList.put(p, p.packetType);
	}
