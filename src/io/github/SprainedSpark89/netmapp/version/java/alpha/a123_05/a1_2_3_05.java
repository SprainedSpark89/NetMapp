...
import io.github.SprainedSpark89.netmapp.version.java.alpha.a1010.PacketAddToInv;
...
import io.github.SprainedSpark89.netmapp.version.java.alpha.a110.PacketSetInv;
import io.github.SprainedSpark89.netmapp.version.java.alpha.a110.PacketSetSpawn;
import io.github.SprainedSpark89.netmapp.version.java.alpha.a110.PacketTileEntityData;
...
import io.github.SprainedSpark89.netmapp.version.java.alpha.a123.PacketHealth;
import io.github.SprainedSpark89.netmapp.version.java.alpha.a123.PacketRespawn;

public class a1_2_3_05 extends AlphaVersion {

	public a1_2_3_05(Versions ver) {
		super(ver);
		this.version = "a1.2.3_05";
		...
		p = new PacketSetInv(new ArrayList<Class<?>>(), new ArrayList<String>()); // 5
		this.packetList.put(p, p.packetType);
		...
		p = new PacketTileEntityData(new ArrayList<Class<?>>(), new ArrayList<String>()); // 59
		this.packetList.put(p, p.packetType);
