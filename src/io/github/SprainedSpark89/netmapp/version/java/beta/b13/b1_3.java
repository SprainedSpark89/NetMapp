...
import io.github.SprainedSpark89.netmapp.version.java.beta.b12.PacketInvClick;
...
public class b1_3 extends BetaVersion {

	public b1_3(Versions ver) {
		super(ver);
		this.version = "b1.3";
		this.protocolNumber = 9;
